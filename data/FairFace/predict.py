...
os.chdir("C:/Users/toom/Desktop/uneven_bars/data/FairFace")
...
def detect_face(image_paths,  SAVE_DETECTED_AT, default_max_size=800,size = 300, padding = 0.25):
    ...
    for index, image_path in enumerate(image_paths):
        ...
        print(f'detecting the face in {image_path}...')
        ...
        for idx, image in enumerate(images):
            ...
            path_sp = img_name.split(".png") # I edited this part for our use case, which is only png files with periods in certain file names
            face_name = os.path.join(SAVE_DETECTED_AT,  path_sp[0] + "_" + "face" + str(idx) + ".png")
            print(f'saving detected face from {image_path}!')
...
def predict_age_gender_race(save_prediction_at, imgs_path = 'cropped_faces/'):
    ...
    model_fair_7.load_state_dict(torch.load('fair_face_models/res34_fair_align_multi_7_20190809.pt', map_location ='cpu'))
...
if __name__ == "__main__":
    ...
    predict_age_gender_race("prediction_outputs.csv", SAVE_DETECTED_AT)
