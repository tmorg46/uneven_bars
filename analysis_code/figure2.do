******************************************
*Figure 2: Parallel trends exist in D1????
******************************************
// pending
*here's the code for the NOT "parallel trends" figure for everyone
use "${route}/data/analysis_set.dta", clear

keep if meettitle=="no meet title" & host!="" // just the ordinary meets
...
*****************************************
*now just the D1 folks with the trends!!!
use "${route}/data/analysis_set.dta", clear
