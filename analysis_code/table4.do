***********************************************************************
*Table 4a: Find venues with significant Eq1 Black-to-White coefficients 
***********************************************************************
// done
...
***********************************************************************
*Table 4b: Find venues with significant Eq2 Black-to-White coefficients 
***********************************************************************
// done
*so let's start by tryna find the teams with significant coefficients on our diff-in-diff!
use "${route}/data/analysis_set.dta", clear
...
*********************************************************************
*Table 4c: Find venues with significant Eq1 White-to-not coefficients 
*********************************************************************
// done
*so let's start by tryna find the teams with significant coefficients on our diff-in-diff!
use "${route}/data/analysis_set.dta", clear
...
cap log close
log using "${route}/output/table4c_log.txt", text replace nomsg // we gotta get the list of 
...
*********************************************************************
*Table 4d: Find venues with significant Eq2 White-to-not coefficients 
*********************************************************************
// done
*so let's start by tryna find the teams with significant coefficients on our diff-in-diff!
use "${route}/data/analysis_set.dta", clear
...
cap log close
log using "${route}/output/table4d_log.txt", text replace nomsg // we gotta get the list of 
